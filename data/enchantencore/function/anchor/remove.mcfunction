...
execute as @e[type=happy_ghast] unless predicate enchantencore:entity/has_anchor run attribute @s minecraft:flying_speed modifier remove enchantencore:anchor
...
execute as @e[type=#enchantencore:rideable] unless predicate enchantencore:entity/has_anchor run attribute @s minecraft:movement_speed modifier remove enchantencore:anchor
